...
pattern = re.compile("""fxgt.gettext\((.+?['"])\)""")

# Support for python < 2.7 (OrderedDict is standard in 2.7 only)
...
class CustomOrderedDict(dict, DictMixin):
